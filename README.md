...
🚀 Fullstack Engineer | Backend & Cloud Focus  
💡 Building scalable systems, APIs & business integrations  
🌎 Ecuador  
...
<p align="left">
  <a href="https://www.linkedin.com/in/juan-collantes-j2systems/">
    <img alt="LinkedIn" src="https://img.shields.io/badge/LINKEDIN-6A788D?style=for-the-badge&logo=linkedin&logoColor=white" />
  </a>
</p>
...
<p align="left">
  <a href="https://github.com/J2-REACT-NATIVE">
...
<p align="left">
  <a href="https://github.com/J2-UI-PROJECTS">
    <img width="40" height="40" src="https://avatars.githubusercontent.com/u/172938185?s=200&v=4" alt="Shadcn-UI"/>
...
`Node.js` · `TypeScript` · `React.js` · `Next.js` · `Nest.js` · `AWS` · `Serverless` · `PostgreSQL` · `Prisma` · `Python` · `Odoo`
